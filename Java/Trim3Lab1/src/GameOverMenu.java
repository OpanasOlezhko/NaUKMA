...
public class GameOverMenu extends JPanel implements KeyListener, MouseListener, MouseMotionListener {
    ...
    public GameOverMenu(WindowGame window){
        addMouseListener(this);
        addMouseMotionListener(this);
        gameOverImg = Toolkit.getDefaultToolkit().createImage("game_over_img.gif");
        ...
        restartbounds = new Rectangle(125, 380, 200, 40);
        menubounds = new Rectangle(170, 450, 110, 40);
    ...
    public void paintComponent(Graphics g){
        ...
        if (restartbounds.contains(mouseX, mouseY)) {
            g.drawImage(restartButton, 128, 383, this);
        } else {
            g.drawImage(restartButton, 125, 380, this);
        }

        if (menubounds.contains(mouseX, mouseY)) {
            g.drawImage(menuButton, 173, 453, this);
        } else {
            g.drawImage(menuButton, 170, 450, this);
        }
